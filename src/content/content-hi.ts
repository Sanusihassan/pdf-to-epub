...
export const tool: _tool = {
  PDF_to_EPUB: {
    ...
    seoTitle:
      "ऑनलाइन PDF से EPUB में कन्वर्ट करें - मुफ्त PDF से EPUB कन्वर्टर",
    description:
      "ई-रीडर और टैबलेट पर आसानी से पढ़ने के लिए अपने PDF दस्तावेज़ों को EPUB प्रारूप में कन्वर्ट करें।",
    color: "#86b910",
    type: ".epub",
    to: "/pdf-to-epub",
    features: [
      ...
      },
      {
        ...
        description:
          "PDFEquips आपके PDF दस्तावेज़ों को EPUB प्रारूप में सटीक रूप से परिवर्तित करता है, जितना हो सके मूल लेआउट और स्वरूपण को संरक्षित करता है।",
      },
      {
        title: "ऑनलाइन सुरक्षित रूप से PDF से EPUB में कन्वर्ट करें",
        description:
          "आपके द्वारा हमारे सर्वर पर अपलोड और बनाई गई सभी फ़ाइलें सुरक्षा कारणों से TLS का उपयोग करके एन्क्रिप्ट की जाती हैं। प्रोसेसिंग के बाद उन्हें तुरंत और स्थायी रूप से हटा दिया जाएगा। अधिक जानकारी के लिए, कृपया हमारी गोपनीयता नीति देखें।",
      },
    ],
    keywords:
      "PDF से EPUB कन्वर्ट करें, PDF से EPUB कन्वर्टर, मुफ्त PDF से EPUB, ऑनलाइन PDF से EPUB, PDF से EPUB रूपांतरण, मुफ्त में ऑनलाइन PDF से EPUB कन्वर्ट करें, मुफ्त PDF से EPUB कन्वर्टर, PDF से EPUB टूल, PDF से EPUB प्रारूप में कन्वर्ट करें, ऑनलाइन PDF से EPUB रूपांतरण टूल, सुरक्षित PDF से EPUB रूपांतरण, PDF से EPUB ऑनलाइन कन्वर्टर",
  },
...
export const edit_page: _edit_page = {
  edit_page_titles: {
    pdf_to_epub: "PDF से EPUB रूपांतरण विकल्प",
  },
...
export const downloadFile: _downloadFile = {
  titles: {
    "pdf-to-epub": [
      "PDF फ़ाइलों को EPUB में परिवर्तित कर दिया गया है!",
      "PDF फ़ाइल को EPUB में परिवर्तित कर दिया गया है!",
    ],
  },
  ...
  backto: {
    "pdf-to-epub": "PDF को EPUB में कन्वर्ट करने के लिए वापस जाएं",
  },
};
